...
if (isset($_POST['update'])) {
    ...
    $email = escape($_POST['email']); // New email field
    ...
    if (!empty($_FILES['userPhoto']['name'])) {
        ...
        if (!move_uploaded_file($_FILES['userPhoto']['tmp_name'], $uploadDirectory . $userPhoto)) {
    ...
    $sql = "UPDATE `user` SET `fullName`='$fullName', `userName`='$userName', `phoneNumber`='$phoneNumber',
        `password`='$password', `userPhoto`='$userPhoto', `role`='$role', `email`='$email', `date`='$date' WHERE `id`='$uid'";
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control is-valid" id="email" value="<?php echo htmlspecialchars($email) ?>" required>
                                            <div class="invalid-feedback">
